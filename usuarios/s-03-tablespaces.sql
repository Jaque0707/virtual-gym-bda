...
CREATE BIGFILE TABLESPACE clientes_c2_lob_ts
    DATAFILE '/unam/bda/pf/c2/d01/clientes_c2_lob_ts_01.dbf'
    SIZE 10G
...
REATE BIGFILE TABLESPACE operacion_c1_data_ts
    DATAFILE '/unam/bda/pf/c1/d01/operacion_c1_data_ts_01.dbf'
    SIZE 5G
    AUTOEXTEND ON NEXT 500M
    MAXSIZE 20G;
