...
drop tablespace if exists infra_c1_data_ts including contents and datafiles;
drop tablespace if exists infra_c1_ix_ts including contents and datafiles;
drop tablespace if exists infra_c2_lob_ts including contents and datafiles;
drop tablespace if exists infra_c1_lob_ts including contents and datafiles;
drop tablespace if exists infra_c2_hist_ts including contents and datafiles;

-- 1. Tablespace para Datos Operativos (Capa 1)
-- Almacena tablas como: gimnasio, sala, aparato, disciplina
CREATE BIGFILE TABLESPACE infra_c1_data_ts
...
CREATE BIGFILE TABLESPACE infra_c1_ix_ts
...
CREATE BIGFILE TABLESPACE infra_c2_lob_ts
  BLOCKSIZE 16K
...
CREATE BIGFILE TABLESPACE infra_c1_lob_ts
...
CREATE BIGFILE TABLESPACE infra_c2_hist_ts
