...
-- Procedimiento para cargar fotos de empleados

create or replace procedure carga_img_empleados is 
    v_bfile  bfile;
    v_blob   blob;
    v_foto   varchar2(20);
begin
...
/
show errors
prompt ==> Realizando carga de fotos de empleados
begin
  carga_img_empleados;
end;
/
prompt ==> Carga de fotos de empleados finalizada, confirmando cambios.
commit; 
